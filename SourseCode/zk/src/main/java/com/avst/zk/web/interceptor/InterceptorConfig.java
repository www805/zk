...
//        registration.addPathPatterns("/zk/**");
        ...
        registration.excludePathPatterns("/gotologin", "/logining", "/error", "/static/**", "/logout","/main/getNavList","/main/goguidepage","/main/getServerStatus","/main/gotologin","/main/gotologin/","/main/getClientUrl","/main/getLoginCookie");       //添加不拦截路径
